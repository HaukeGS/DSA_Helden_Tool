...
class LanguageAventurianManager extends BaseAventurianManager {
	private final Predicate<Language> IS_NATIVE_TONGUE = l -> l.isNativeTongue();
	private final Predicate<Aventurian> HAS_ALREADY_NATIVE_TONGUE = av -> av.hasNativeTongue();
